...
2. **Check context** — Read `devdocs/memory/decisions.md` and `devdocs/memory/conventions.md` for established patterns. Search the codebase for relevant existing code. Use web search when needed to verify technical claims or best practices.
