...
7. **Finalize** — Write the spec to `docs/specs/<yyyy-mm-dd>_<feature-shortname>.md` using the format below. Update `docs/memory/decisions.md` with any new architectural decisions.
